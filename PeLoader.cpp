...
static void MemClean(std::vector<void*> allocedMem)
{
	for (auto& it : allocedMem)
	{
		VirtualFree(it, NULL, MEM_RELEASE);
	}
}



bool PeLoader::MapPe(__in const std::string& fileName)
{	
